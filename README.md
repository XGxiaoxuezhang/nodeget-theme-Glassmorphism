...
## 基于 Glassmorphism 视觉风格的 NodeGet 公开监控主题

保留原有的毛玻璃界面、节点卡片、地球和详情图表，同时将数据层适配到 NodeGet JSON-RPC。项目面向公开只读探针，不提供 NodeGet 管理后台、命令执行或 WebShell。
...
**作者：** [XGxiaoxuezhang](https://github.com/XGxiaoxuezhang) · **仓库：** [XGxiaoxuezhang/komari-theme-Glassmorphism](https://github.com/XGxiaoxuezhang/komari-theme-Glassmorphism)
...
- 禁用前端 IP/GeoIP 查询，不把节点 IP 发送给第三方 GeoIP 服务
...
本项目是在原 Glassmorphism 主题基础上进行 NodeGet 适配和公开探针改造，保留上游项目的版权和 MIT License。感谢原作者以及 Vue、Vite、Tailwind CSS、reka-ui 和 NodeGet 社区。

- 上游参考：<https://github.com/sanrokamlan-prog/komari-theme-Glassmorphism>
- NodeGet：<https://nodeget.com/>
- 当前维护者：<https://github.com/XGxiaoxuezhang>
